...
class GripperState(ctypes.Structure):
    ...
    def __repr__(self):
        s = f"enable_state:{self.enable_state},status:{self.status},error:{self.error},mode:{self.mode},current_force:{self.current_force},temperature:{self.temperature},actpos:{self.actpos}"
        return s
