...
def main():
    config_file = "./detectron2/projects/PointRend/configs/InstanceSegmentation/pointrend_rcnn_R_50_FPN_3x_xarm.yaml"
    model_weight = "./detectron2/projects/PointRend/output/model_0099999.pth"
    image_path = "./cam_robot_calib/data/sim_for_hec/space_explore_from_manual3_topk_it00_nostep_rt/color/000000.png"
